...
<body>
  ...
  <div class="row">
    <div class="col-sm">
      <button class="btn btn-primary" data-toggle = "modal" data-target ="#myModalG">Tambah Gudang</button>
      <!-- Modal -->
        <div id="myModalG" class="modal fade" role="dialog" style="color:black;">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" action="function/input_gudang.php">
                  <div class="form-group">
                    <label for="id_property">ID Gudang</label>
                    <input type="text" class="form-control" name="id_gudang" id="id_gudang">
                  </div>
                  <div class="form-group">
                    <label for="nama_property">Lokasi Gudang</label>
    ...
    <div class="col-sm">
    <button class="btn btn-primary" data-toggle = "modal" data-target ="#myModalB">Tambah Item Bahan Baku</button>
      <!-- Modal -->
        <div id="myModalB" class="modal fade" role="dialog" style="color:black;">
          <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form method="post" action="function/input_bb.php">
                  <div class="form-group">
                    <label for="id_property">ID Bahan Baku</label>
                    <input type="text" class="form-control" name="id_bb" id="id_bb">
                  </div>
                  <div class="form-group">
                    <label for="nama_property">Nama Bahan Baku</label>

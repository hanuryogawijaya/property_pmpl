...
<div class="tab-content" id="myTabContent">
  ...
  ?>
    ...
    <tr scope="row">
      ...
      <td><button class="btn btn-primary" data-toggle = "modal" data-target ="#myModal<?php echo $data['id_pesanan']?>">Detail</button></td>
      ...
      <!-- Modal -->
        <div id="myModal<?php echo $data['id_pesanan']; ?>" class="modal fade" role="dialog" style="color:black;">
          <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
              <div class="modal-header">
